...
import 'package:jobizy/app/module/jobsection/jobfullview/fullview.dart';
import 'package:provider/provider.dart';

Consumer<SearchController> searchCard(SearchController provider) {
  return Consumer<SearchController>(builder: ((context, value, child) {
    return ListView.separated(
      ...
      itemBuilder: (context, index) {
        return GestureDetector(
          onTap: () {
            print(provider.allsearchjobs[index].id);
              ...
              child: Column(
                ...
                children: [
                  Row(
                    children: [
                      Container(
                          ...
                          child: provider.allsearchjobs[index].image == null
                              ? Container(
                                  width: 50,
                                  height: 50,
                      ...
                      Column(
                        ...
                        children: [
                          Text(
                            provider.allsearchjobs[index].company.toString(),
                  ...
                  Container(
                    padding: const EdgeInsets.all(8.0),
                    child: Text(
                      provider.allsearchjobs[index].designation.toString(),
                      style: const TextStyle(
                        color: Colors.white,
                        fontWeight: FontWeight.bold,
                        fontSize: 20,
                  ...
                  Container(
                    padding: const EdgeInsets.all(8.0),
                    child: Text(
                      provider.allsearchjobs[index].description.toString(),
                      style: const TextStyle(
                        color: Colors.white,
                      ),
                      maxLines: 2,
